...
- (nonnull instancetype)initWithConsumerKey:(NSString * __nonnull)consumerKey consumerSecret:(NSString * __nonnull)consumerSecret authorizeUrl:(NSString * __nonnull)authorizeUrl accessTokenUrl:(NSString * __nonnull)accessTokenUrl;
...
- (nonnull instancetype)initWithConsumerKey:(NSString * __nonnull)consumerKey consumerSecret:(NSString * __nonnull)consumerSecret authorizeUrl:(NSString * __nonnull)authorizeUrl OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithParameters:(NSDictionary<NSString *, NSString *> * __nonnull)parameters;
